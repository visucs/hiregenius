...
const STAT_CARDS = [
  { label: 'Active Jobs', value: '—', icon: Briefcase, color: 'var(--primary)' },
  { label: 'Total Candidates', value: '—', icon: Users, color: 'var(--secondary)' },
  { label: 'Resumes Screened', value: '—', icon: FileSearch, color: 'var(--success)' },
  { label: 'Interviews Scheduled', value: '—', icon: CalendarDays, color: '#F59E0B' },
];

/**
 * RecruiterDashboard — Phase 1 placeholder.
 * Role: RECRUITER. Real widgets land in Phase 2/3.
 */
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      >
        ...
        >
          ...
          Phase 2 will populate stats, charts, and quick-action panels for recruiters.
        </div>
      </motion.div>
    </div>
  );
