...
const RecruiterAIInterviewPage = () => {
  return (
    <div style={{ background: 'var(--bg-base)', minHeight: '100%' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.38 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.09em', color: 'rgba(107,138,58,0.95)', background: 'rgba(107,138,58,0.14)', padding: '4px 12px', borderRadius: 999, border: '1px solid rgba(107,138,58,0.28)' }}>
                <Play size={11} /> AI Assessment
              </span>
            </div>
            <h1 style={{ fontSize: 'clamp(22px, 4vw, 30px)', fontWeight: 900, color: '#fff', letterSpacing: '-0.04em', marginBottom: 6 }}>AI Interviews</h1>
            <p style={{ fontSize: 13, color: 'rgba(190,220,140,0.60)', paddingBottom: 28 }}>
              Automated first-round candidate assessments and AI-evaluated performance metrics.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <ModulePendingState
        icon={Play}
        moduleName="AI Interview Room"
        title="AI Interviews Coming in Phase 3"
        description="Automated AI interview sessions, question synthesis, and multi-factor response evaluations will be active once the AI Interview Agent microservice is deployed."
        plannedFeatures={[
          'Dynamic role-specific technical question generation',
          'Candidate answer evaluation across technical & communication skills',
          'Complete candidate transcripts and playback scoring breakdown',
          'Actionable recommendation summary for recruitment teams',
        ]}
        phase="Phase 3"
      />
    </div>
