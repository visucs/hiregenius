...
const AnalyticsPage = () => {
  return (
    <div style={{ background: 'var(--bg-base)', minHeight: '100%' }}>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(150deg, #18280a 0%, #0c1505 55%, #0f1e06 100%)', padding: 'clamp(20px, 4vw, 32px) clamp(16px, 4vw, 36px) 0' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.38 }}>
            ...
            <h1 style={{ fontSize: 'clamp(22px, 4vw, 30px)', fontWeight: 900, color: '#fff', letterSpacing: '-0.04em', marginBottom: 6 }}>Analytics & Reporting</h1>
            <p style={{ fontSize: 13, color: 'rgba(190,220,140,0.60)', paddingBottom: 28 }}>
              Hiring funnel performance, time-to-hire metrics, and sourcing analytics.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <ModulePendingState
        icon={BarChart3}
        moduleName="Recruitment Analytics"
        title="Recruitment Analytics Coming in Phase 3"
        description="Comprehensive funnel metrics, score distribution charts, and recruitment velocity reporting will become active once the Analytics aggregation module is built."
        plannedFeatures={[
          'End-to-end recruitment funnel tracking (Job Post → Offer)',
          'Resume score distribution and candidate quality percentiles',
          'Interview completion and candidate drop-off metrics',
          'Exportable CSV and PDF hiring analytics reports',
        ]}
        phase="Phase 3"
      />
    </div>
