    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        <button
          onClick={onClose}
          className="md:hidden"
          style={{ background: 'none', border: 'none', color: ADMIN.textMuted, cursor: 'pointer', padding: 4 }}
        >
          <X size={18} />
        </button>
      </div>
      ...
      {/* ── User card ────────────────────────────────────────── */}
      <div style={{ borderTop: `1px solid ${ADMIN.borderSub}`, padding: isCollapsed ? '10px 8px' : '10px 12px', flexShrink: 0 }}>
        {isCollapsed ? (
          <div style={{
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', color: '#6366f1' }}>
            Admin Console
          </span>
        </div>
