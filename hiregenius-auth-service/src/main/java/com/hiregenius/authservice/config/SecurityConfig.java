...
import com.hiregenius.authservice.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:5173,http://localhost:80,http://localhost:3000}")
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            com.hiregenius.authservice.exception.ApiError error =
                                    new com.hiregenius.authservice.exception.ApiError(
